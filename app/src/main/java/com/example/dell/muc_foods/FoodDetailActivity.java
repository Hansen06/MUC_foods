...
import com.example.dell.muc_foods.fragment.FragmentOne;
import com.example.dell.muc_foods.fragment.FragmentTwo;
...
//        this.getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);//去掉信息栏
        ...
        tb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(FoodDetailActivity.this, MainActivity.class);
    ...
    private class MyPagerAdapter extends FragmentStatePagerAdapter{
        ...
        public Fragment getItem(int position) {
            switch (position){
                case 0:return FragmentTwo.newInstance();
                case 1:return FragmentOne.newInstance();
